...
- **Onboarding** (three screens, each a reason before a feature): the problem ("You saved 200 reels. You've been to none."), what makes Xplore different ("Plans your whole group agrees on", with a mini vote card: Om Beach, three friends, Meera pushing for Paradise Beach), and the weekly reason to come back ("The ones near home become your weekends"), which is where the district picker now sits, right under its reason. How things work is left to the app, where it's obvious.
